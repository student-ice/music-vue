...
import { getBannerList,getRecommendlist,getNewsong,getSongUrl ,getMv} from "../api/discover.js";
...
<template>
  <div class="discover-container">
    ...
    <div class="news">
      ...
      <div class="items">
        <div class="item" v-for="(item, index) in state.newsong.result" :key="index">
          <div class="img-wrap">
            <img :src="item.picUrl" alt />
              <span @click="playMusic(item.id)" class="iconfont icon-iceplay"></span>
          </div>
          <div class="song-wrap">
